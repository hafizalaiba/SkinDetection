...
def download_report(history_id):
    ...
    try:
        ...
        pdf.drawImage(circular_logo_path, 450, 710, width=pdf_size * 0.18, height=pdf_size * 0.18, mask='auto')
    ...
    pdf.drawString(160, 730, date)

    pdf.setFont("Helvetica-Bold", 12)
    pdf.drawString(100, 710, "Skin Type:")
    pdf.setFont("Helvetica", 12)
    pdf.drawString(180, 710, skin_type)

    pdf.setFont("Helvetica-Bold", 12)
    pdf.drawString(100, 690, "Acne Detected:")
    pdf.setFont("Helvetica", 12)
    pdf.drawString(200, 690, acne_status)


    

# 🧴 RECOMMENDATION (with bold heading)
    pdf.setFont("Helvetica-Bold", 12)
